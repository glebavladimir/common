...
//   args - <any[]>, extra arguments passed to arrayFunc or objectFunc
// Returns: <Object> | <Array>
const applyArrObj = (val, arrayFunc, objectFunc, ...args) => {
...
//   obj - <Object> | <Array>
// Returns: <Object> | <Array>
const clone = obj => applyArrObj(obj, cloneArray, cloneObject);
...
// Returns: <Object> | <Array>
const duplicate = obj =>
  applyArrObj(obj, duplicateArray, duplicateObject, new Map());
...
const duplicateFields = (references, srcObj, dstObj, fieldNames) => {
  for (const fieldName of fieldNames) {
    ...
    if (references.has(val)) {
      ...
      dstObj[fieldName] =
        applyArrObj(val, duplicateArray, duplicateObject, references);
    }
  }
};
